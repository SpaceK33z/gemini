...
describe('gemini', () => {
    ...
    describe('on "INTERRUPT"', () => {
        ...
        const emulateRunnerInterrupt = () => stubRunner(() => signalHandler.emit(Events.INTERRUPT));
        ...
        it('should emit "INTERRUPT" event from gemini', () => {
            ...
            return gemini.test().then(() => assert.calledOnce(onCancel));
        });
        ...
        it('should emit "INTERRUPT" event from gemini before cancelling of gemini runner', () => {
            ...
            return gemini.test().then(() => assert.callOrder(onCancel, Runner.prototype.cancel));
        });
    });
});
